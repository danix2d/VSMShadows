Shader "Custom/VSM_Lit_Shadow"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "ShaderLibrary/VSM_Shadows.hlsl"
           ...
           //     if (_UseShadows > 0.5)
           //     {
                  float  shadow = SampleCustomShadow(i.worldPos, i.normal);
           //     }
                ...
                float3 finalLightCol = ambientColor + (lightCol * shadow);
